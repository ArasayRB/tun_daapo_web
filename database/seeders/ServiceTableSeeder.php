...
class ServiceTableSeeder extends Seeder
{
  use ContentTypeTrait, TranslateTrait, LanguageTrait, ServiceTrait;
    ...
    {
      $service=new Service();
      $service->img='Difusion_en_Redes_SocialesSFondo.png';
      $service->img_descript='nethwork sociality manage';
      ...
      $service=new Service();
      $service->img='seo.jpg';
      $service->img_descript='optimization and seo position';
      ...
      $service=new Service();
      $service->img='Design.png';
      $service->img_descript='image design';
      ...
      $service=new Service();
      $service->img='Programacion.jpg';
      $service->img_descript='web programming';
      ...
      $service=new Service();
      $service->img='Marketing_Digital.png';
      $service->img_descript='content creator';
