...
class ServiceTableSeeder extends Seeder
{
  use ContentTypeTrait, TranslateTrait, LanguageTrait, ServiceTrait;
    ...
    {
      $service=new Service();
      $service->img='BombillaMarketing.png';
      ...
      $service=new Service();
      $service->img='pexels-pixabay-270637.jpg';
      ...
      $service=new Service();
      $service->img='DiseñoIntegral.png';
      ...
      $service=new Service();
      $service->img='MarketingDomino.png';
      ...
      $service=new Service();
      $service->img='contenido_digital.jpg';
